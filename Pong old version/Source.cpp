...
int mai(void)
{
	...
	Vector2 VelBallon;
	//images an music
	Image Grassground = LoadImage("../img/green-grass-background_1373-334.jpg");
	Image PlayersImage = LoadImage("../img/glasses.png");
	Image PlayersImage2 = LoadImage("../img/glasses2.png");
	Image BallImage = LoadImage("../img/ball.png");
	...
	InitAudioDevice();
	Music backMusic = LoadMusicStream("../sound/waterflame-endgame.ogg");
	Sound glassBroken = LoadSound("../sound/glass-break-song.wav");
